         ...
         <div id="order-success">
                	<div class="row">
                        ...
                        <div id="order-success-txt" class="col-lg-9 col-md-9 col-sm-12">
                          <img class="order-success" src="img/order-success.png" alt="dathangthanhcong">
                        	<h3 class="order-success_text">BẠN ĐÃ ĐẶT HÀNG THÀNH CÔNG !</h3>
                          <p class="order-success-detail">Vui lòng kiểm tra email để xem lại thông tin đơn hàng của mình.</p>
                        </div>
                    </div>    
                </div>
                <!--	End Order Success	-->
